...
Remove first prompt + rewrite rest in new format
...
class Talk:
    ...
    def __init__(self, save, prompts, prompts_num):
        ...
        # Setup current_prompt_index and array
...
# Example usage
# Auto generated by chatgpt, don't trust, if this is kept it'll be changed by the time the script works. 
if __name__ == "__main__":
    save = "example_save"
    prompts = ["Prompt 1", "Prompt 2", "Prompt 3"]
    prompts_num = len(prompts)
    
    talk_instance = Talk(save, prompts, prompts_num)
    talk_instance.run()
